...
public class TestCustomerWiseIncrementalOutboundIdGenerator {
    ...
    public void test_success_already_existing_outbound() {
        StartOutboundRequest startOutboundRequest = StartOutboundRequest.builder().customerId(CUSTOMER_1).warehouseId(WAREHOUSE_1).userId(USER_1).build();
