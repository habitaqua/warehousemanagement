...
import org.warehousenamagement.entities.dynamodb.Inventory;
...
public class InventoryDbSAO {
    ...
    public InventoryDbSAO(AmazonDynamoDBClient amazonDynamoDBClient, DynamoDBMapper inventoryDynamoDbMapper,
            LocationSKUCountDbSAO locationSKUCountDbSAO, Clock clock) {
    ...
    public void add(InventoryDTO inventoryDTO) {
        ...
        Optional<LocationSKUCount> locationSKUCountOptional = getLocationSKUCount(inventoryDTO);
    ...
    private Optional<LocationSKUCount> getLocationSKUCount(InventoryDTO inventoryDTO) {
        GetLocationSKUCountRequest getLocationSKUCountRequest =
                GetLocationSKUCountRequest.builder().locationId(inventoryDTO.getLocationId())
                        .warehouseId(inventoryDTO.getWarehouseId()).skuCategory(inventoryDTO.getSkuCategory())
                        .skuType(inventoryDTO.getSkuType()).build();
        Optional<LocationSKUCount> locationSKUCountOptional = locationSKUCountDbSAO
                .getLocationSKUCount(getLocationSKUCountRequest);
